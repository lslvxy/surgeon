...
public class SystemUtil {
	...
	public static boolean isLinux() {
		return StrUtil.isNotBlank(OS_NAME) && OS_NAME_LINUX.equals(OS_NAME.toUpperCase());
	}
	...
	public static int getPropToInt(String key, int defaultValue) {
		return Convert.toInt(getProp(key), defaultValue);
	}
	...
	public static boolean getPropToBool(String key, boolean defaultValue) {
		return Objects.requireNonNull(Convert.toBool(getProp(key), defaultValue));
	}
