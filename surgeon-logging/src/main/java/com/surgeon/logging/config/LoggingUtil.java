...
import com.github.surgeon.util.SystemUtil;
...
public class LoggingUtil {
    ...
    public static final  String DEFAULT_FILE_LOG_PATTERN
     ...
     * @param context            a {@link LoggerContext} object.
     * @param customFields       a {@link String} object.
     * @param logStashProperties a {@link com.surgeon.logging.config.SurgeonLoggingProperties.Logstash} object.
     */
    public static void addLogStashTcpSocketAppender(LoggerContext context,
                                                    String customFields,
                                                    SurgeonLoggingProperties.Logstash logStashProperties) {
     ...
     * @param context      a {@link LoggerContext} object.
     * @param customFields a {@link String} object.
     * @param properties   a {@link com.surgeon.logging.config.SurgeonLoggingProperties} object.
     */
    public static void addContextListener(LoggerContext context,
                                          String logFile,
                                          String logErrorFile,
                                          String customFields,
                                          SurgeonLoggingProperties properties) {
        LogbackLoggerContextListener loggerContextListener = new LogbackLoggerContextListener(logFile, logErrorFile, customFields,
                properties);
    ...
    private static RollingPolicy rollingPolicy(LoggerContext context,
        ...
        rollingPolicy.setCleanHistoryOnStart(
                SystemUtil.getPropToBool(LogbackLoggingSystemProperties.ROLLINGPOLICY_CLEAN_HISTORY_ON_START, false));
        rollingPolicy.setFileNamePattern(logErrorFile + ".%d{yyyy-MM-dd}.%i.gz}");
        rollingPolicy.setMaxFileSize(
                FileSize.valueOf(SystemUtil.getProp(LogbackLoggingSystemProperties.ROLLINGPOLICY_MAX_FILE_SIZE, "10MB")));
        ...
        rollingPolicy.setTotalSizeCap(
                FileSize.valueOf(SystemUtil.getProp(LogbackLoggingSystemProperties.ROLLINGPOLICY_TOTAL_SIZE_CAP, "0")));
    ...
    private static class LogbackLoggerContextListener extends ContextAwareBase implements LoggerContextListener {
        ...
        private final SurgeonLoggingProperties loggingProperties;
